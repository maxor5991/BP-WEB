    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu" >
                ...
                <li>
                    <a href="index.php"><i class="fa fa-th-large"></i> <span class="nav-label">Ingresar datos</span> <span class="fa arrow"></span></a>
                    <a href="pie.php"><i class="fa fa-th-large"></i> <span class="nav-label">Grafico Pie</span> <span class="fa arrow"></span></a>
                </li>
            </ul>
